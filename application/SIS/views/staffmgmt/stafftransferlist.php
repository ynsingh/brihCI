...
<table width="100%">
	...
	<?php			if(($record->uit_dateofrelief != '1000-01-01 00:00:00')&&(strcmp($record->uit_dateofrelief,'0000-00-00 00:00:00') !== 0)){
					$uitdorf =date('d-m-Y H:i:s',strtotime($record->uit_dateofrelief));
				}else{
					$uitdorf ='';
				}
				if(($record->uit_dateofjoining != '1000-01-01 00:00:00')&&(strcmp($record->uit_dateofjoining,'0000-00-00 00:00:00') !== 0)){
